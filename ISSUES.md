...
**HELM-043 · `DESIGN` · `OPEN (v1a shipped s50)` · Condor health: short-strike proximity signal live (YELLOW at 50% watch / 75% manage); RED act-reason (v1b) + live greeks (steps 3-4) remain**
