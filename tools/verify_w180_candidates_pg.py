...
case("page_flow", "/api/diagonal/candidates" in page and "rs-panel" in page and "window.prompt(C.length" not in page and "OUTSIDE the" in page and "Selected: " in page, True)
